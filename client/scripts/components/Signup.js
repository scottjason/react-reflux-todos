  ...
  render: function() {
    return (
	  <div styles={styles.formContainer}>
  		...
  		<div styles={styles.button} onClick={actions.getSignupForm}>
  		  <p styles={styles.signupCopy}>SIGNUP</p>
  		</div>
  		<p styles={styles.loginOpt} onClick={actions.toggleLanding}>have an account?</p>              	
	  </div>
    )
  }
});
